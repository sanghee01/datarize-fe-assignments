...
import { MIN_DATE, MAX_DATE } from '@/shared/config'
...
export function DateRangeSelector({ dateRange, onChange }: Props) {
  const { error, touched, handleFromChange: validateFrom, handleToChange: validateTo } = useDateFilter()
